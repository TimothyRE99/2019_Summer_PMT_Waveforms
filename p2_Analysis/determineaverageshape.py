...
def determine_average_shape(datadate,numhead):
    Nloops = len(os.listdir('G:/data/watchman/'+datadate+'_watchman_spe/d2/d2_normalized'))
...
def generate_average_shape_plot(datadate,numhead):
    ...
    fig.savefig('G:/data/watchman/'+datadate+'_watchman_spe/d2/d2_histograms/average_shape.png',dpi = 300)
