...
if __name__ == '__main__':
    ...
    parser.add_argument("--filename",type=str,help="filename",default='g:/data/watchman/20190724_watchman_spe/d2/d2_average_quadrupled.txt')
    parser.add_argument("--writename",type=str,help="filename",default='g:/data/watchman/20190724_watchman_spe/d2/d2_average_octupled.txt')
