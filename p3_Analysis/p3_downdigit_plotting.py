...
for i in range(Nloops):
    ...
    (t_double,v_double,_) = rw('G:/Data/watchman/20190516_watchman_spe/d3/d3_averages/rise_doubled/D3--waveforms--%05d.txt' % i,5)
    (t_quadruple,v_quadruple,_) = rw('G:/Data/watchman/20190516_watchman_spe/d3/d3_averages/rise_quadrupled/D3--waveforms--%05d.txt' % i,5)
    (t_octuple,v_octuple,_) = rw('G:/Data/watchman/20190516_watchman_spe/d3/d3_averages/rise_octupled/D3--waveforms--%05d.txt' % i,5)
