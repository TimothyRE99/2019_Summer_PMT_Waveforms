...
numhead = 5
writename = 'G:/data/watchman/20190514_watchman_spe/d1/d1_histograms/10_90_fall_time.txt'
...
for i in range(Nloops):
    ...
    fall_time = (t[index_10] - t[index_90])                         #fall time is time at 10% - time at 90%
