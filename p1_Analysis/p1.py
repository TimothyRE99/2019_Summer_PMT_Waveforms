...
def p1(NLoops, datadate, numhead, fsps, fc, numtaps, j, threshold, baseline):
    ...
    for i in range(j, NLoops):
        p1_sort(i,datadate,lowpass,numhead,numtaps,threshold,baseline)          #running p1_sort function to sort files
