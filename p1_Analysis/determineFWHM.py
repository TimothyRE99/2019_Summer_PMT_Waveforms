...
def determine(datadate,numhead):
    ...
    for i in range(Nloops):
        ...
        index_first = int(index_low[len(index_low)-1] + 0.5)#turning last 50% point before peak into int
        index_last = int(index_high[0] + 0.5)               #turning first 50% point after peak into int
